...
namespace Test
{
    ...
    struct JsonDouble : public tars::TarsStructBase
    {
    public:
        static string className()
        {
            return "Test.JsonDouble";
        }
        static string MD5()
        {
            return "f6db8240750e5242e4b530283aefcd3d";
        }
        JsonDouble()
        {
            resetDefautlt();
        ...
        {
            tars::TarsDisplayer _ds(_os, _level);
            _ds.displaySimple(d, false);
            return _os;
        }
    public:
        tars::Double d;
    };
    inline bool operator==(const JsonDouble&l, const JsonDouble&r)
    {
        return tars::TC_Common::equal(l.d,r.d);
    }
    inline bool operator!=(const JsonDouble&l, const JsonDouble&r)
    {
        return !(l == r);
    }
    inline ostream& operator<<(ostream & os,const JsonDouble&r)
    {
        os << r.writeToJsonString();
        return os;
    }
    inline istream& operator>>(istream& is,JsonDouble&l)
    {
        std::istreambuf_iterator<char> eos;
        std::string s(std::istreambuf_iterator<char>(is), eos);
        l.readFromJsonString(s);
    ...
    public:
        ...
        virtual void callback_testClose(tars::Int32 ret)
        { throw std::runtime_error("callback_testClose() override incorrect."); }
        virtual void callback_testClose_exception(tars::Int32 ret)
        { throw std::runtime_error("callback_testClose_exception() override incorrect."); }
        ...
        virtual void callback_testConHash(tars::Int32 ret, std::string&&  sOut)
        { callback_testConHash(ret, sOut); }
        ...
        virtual void callback_testCoro(tars::Bool ret, std::string&&  sOut)
        { callback_testCoro(ret, sOut); }
        ...
        virtual void callback_testDyeing(tars::Int32 ret, std::string&&  strOut)
        { callback_testDyeing(ret, strOut); }
        ...
        virtual void callback_testHello(tars::Int32 ret, std::string&&  r)
        { callback_testHello(ret, r); }
        ...
        virtual void callback_testPid(tars::Int32 ret, std::string&&  r)
        { callback_testPid(ret, r); }
        ...
        virtual void callback_testSyncTrans(tars::Int32 ret, std::string&&  r)
        { callback_testSyncTrans(ret, r); }
        ...
        virtual void callback_testTrans(tars::Int32 ret, std::string&&  r)
        { callback_testTrans(ret, r); }
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Hello_all, __Hello_all+11, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            ...
            switch(r.first - __Hello_all)
            {
                case 0:
                {
                    ...
                    {
                        callback_testClose_exception(_msg_->response->iRet);
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", ServerConfig::Application + "." + ServerConfig::ServerName, "testClose", 0, _trace_param_, "");
                    }
                ...
                case 1:
                {
                    ...
                    callback_testConHash(_ret, std::move(sOut));
                ...
                case 2:
                {
                    ...
                    callback_testCoro(_ret, std::move(sOut));
                ...
                case 3:
                {
                    ...
                    callback_testDyeing(_ret, std::move(strOut));
                ...
                case 5:
                {
                    ...
                    callback_testHello(_ret, std::move(r));
                ...
                case 6:
                {
                    ...
                    callback_testPid(_ret, std::move(r));
                ...
                case 8:
                {
                    ...
                    callback_testSyncTrans(_ret, std::move(r));
                ...
                case 10:
                {
                    ...
                    callback_testTrans(_ret, std::move(r));
    ...
    public:
        struct PromisetestClose: virtual public TC_HandleBase
        {
        public:
            tars::Int32 _ret;
        ...
        typedef tars::TC_AutoPtr< HelloPrxCallbackPromise::PromisetestClose > PromisetestClosePtr;

        HelloPrxCallbackPromise(const tars::Promise< HelloPrxCallbackPromise::PromisetestClosePtr > &promise)
        : _promise_testClose(promise)
        {}
        
        virtual void callback_testClose(const HelloPrxCallbackPromise::PromisetestClosePtr &ptr)
        {
            _promise_testClose.setValue(ptr);
        }
        virtual void callback_testClose_exception(tars::Int32 ret)
        {
            std::string str("");
            str += "Function:testClose_exception|Ret:";
            str += TC_Common::tostr(ret);
            _promise_testClose.setException(tars::copyException(str, ret));
        }

    protected:
        tars::Promise< HelloPrxCallbackPromise::PromisetestClosePtr > _promise_testClose;
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Hello_all, __Hello_all+11, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Hello_all)
            {
                case 0:
                {
                    ...
                    HelloPrxCallbackPromise::PromisetestClosePtr ptr = new HelloPrxCallbackPromise::PromisetestClose();
                    ...
                    {
                        callback_testClose_exception(tars::TARSCLIENTDECODEERR);
    ...
    public:
        ...
        tars::Int32 testClose(const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, ServerConfig::Application + "." + ServerConfig::ServerName, tars_name(), "testClose", 0, _trace_param_, "");
            }

            std::map<string, string> _mStatus;
            shared_ptr<tars::ResponsePacket> rep = tars_invoke(tars::TARSNORMAL,"testClose", _os, context, _mStatus);
            if(pResponseContext)
            {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, ServerConfig::Application + "." + ServerConfig::ServerName, tars_name(), "testClose", 0, _trace_param_, "");
            }

            return _ret;
        }

        void async_testClose(HelloPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            ServantProxyThreadData *_pSptd_ = ServantProxyThreadData::getData();
            ...
            tars_invoke_async(tars::TARSNORMAL,"testClose", _os, context, _mStatus, callback);
        }
        
        tars::Future< HelloPrxCallbackPromise::PromisetestClosePtr > promise_async_testClose(const map<string, string>& context)
        {
            tars::Promise< HelloPrxCallbackPromise::PromisetestClosePtr > promise;
        ...
        void coro_testClose(HelloCoroPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"testClose", _os, context, _mStatus, callback, true);
        }
    ...
    public:
        virtual ~Hello(){}
        virtual tars::Int32 testClose(tars::TarsCurrentPtr _current_) = 0;
        static void async_response_testClose(tars::TarsCurrentPtr _current_, tars::Int32 _ret)
        {
            size_t _rsp_len_ = 0;
            ...
            if (_current_->isTraced())
            {
                ...
                TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", ServerConfig::Application + "." + ServerConfig::ServerName, "testClose", 0, _trace_param_, "");
            }

        }
        static void async_response_push_testClose(tars::CurrentPtr _current_, tars::Int32 _ret, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);

                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"testClose", _os, _context);
            }
        }
        ...
        virtual tars::Bool testCoro(std::string && sIn,std::string &sOut,tars::TarsCurrentPtr _current_) 
        { return testCoro(sIn, sOut, _current_); }
        ...
        virtual tars::Int32 testDyeing(std::string && strIn,std::string &strOut,tars::TarsCurrentPtr _current_) 
        { return testDyeing(strIn, strOut, _current_); }
        ...
        virtual tars::Int32 testHello(tars::Int32 index,std::string && s,std::string &r,tars::TarsCurrentPtr _current_) 
        { return testHello(index, s, r, _current_); }
        ...
        virtual tars::Int32 testPushRegister(std::string && msg,tars::TarsCurrentPtr _current_) 
        { return testPushRegister(msg, _current_); }
        ...
        virtual tars::Int32 testSyncTrans(tars::Int32 index,std::string && s,std::string &r,tars::TarsCurrentPtr _current_) 
        { return testSyncTrans(index, s, r, _current_); }
        ...
        virtual tars::Int32 testTrans(tars::Int32 index,std::string && s,std::string &r,tars::TarsCurrentPtr _current_) 
        { return testTrans(index, s, r, _current_); }
    ...
    public:
        int onDispatch(tars::TarsCurrentPtr _current, vector<char> &_sResponseBuffer)
        {
            ...
            pair<string*, string*> r = equal_range(__Test__Hello_all, __Test__Hello_all+11, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Test__Hello_all)
            {
                case 0:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", ServerConfig::Application + "." + ServerConfig::ServerName, "testClose", 0, _trace_param_, "");
                    }

                    tars::Int32 _ret = testClose(_current);
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", ServerConfig::Application + "." + ServerConfig::ServerName, "testClose", 0, _trace_param_, "");
                        }
                ...
                case 2:
                {
                    ...
                    tars::Bool _ret = testCoro(std::move(sIn),sOut, _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
                ...
                case 3:
                {
                    ...
                    tars::Int32 _ret = testDyeing(std::move(strIn),strOut, _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
                ...
                case 5:
                {
                    ...
                    tars::Int32 _ret = testHello(index,std::move(s),r, _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
                ...
                case 7:
                {
                    ...
                    tars::Int32 _ret = testPushRegister(std::move(msg), _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
                ...
                case 8:
                {
                    ...
                    tars::Int32 _ret = testSyncTrans(index,std::move(s),r, _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
                ...
                case 10:
                {
                    ...
                    tars::Int32 _ret = testTrans(index,std::move(s),r, _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
